...
-- INSERINDO DADOS ALEATORIOS NA TABELA ITEM_NOTA

DECLARE

		@ID_PRODUTO INT, @ID_NOTA_FISCAL INT, @QUANTIDADE INT,
		@VALOR NUMERIC(10,2), @TOTAL NUMERIC(10,2)
...
-- VIEW DE ITENS DE NOTA

CREATE VIEW V_ITEM_NOTA
	AS
